...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", 8095670572).split())
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/Chini_tomarre")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://i.ibb.co/RcTvd4J/photo-2025-01-21-06-54-08-7462258510022049796.jpg",
)
