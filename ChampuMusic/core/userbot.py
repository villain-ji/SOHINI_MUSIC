    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Tbf_chat")
                await self.one.join_chat("Moodswiingsss")
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("Moodswiingsss")
                await self.two.join_chat("About_Sohini")
                await self.two.join_chat("Tbf_chat")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("Tbf_chat")
                await self.three.join_chat("About_Sohini")
                await self.three.join_chat("Moodswiingsss")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Tbf_chat")
                await self.four.join_chat("Moodswiingsss")
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("Moodswiingsss")
                await self.five.join_chat("Tbf_chat")
