from ChampuMusic import pbot as app
from ChampuMusic import BOT_USERNAME
    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://envs.sh/gzH.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💌 ᴡʜɪsᴘᴇʀ",
            description=f"@SohiniMusic_Bot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**⬤ ᴜsᴀɢᴇ ➥**\n\n@SohiniMusic_Bot (ᴛᴀʀɢᴇᴛ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ) (ʏᴏᴜʀ ᴍᴇssᴀɢᴇ).\n\n**๏ ᴇxᴀᴍᴘʟᴇ ➠**\n@SohiniMusic_Bot @username ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ"),
            thumb_url="https://envs.sh/gzH.jpg",
            reply_markup=switch_btn
        )
    ]
